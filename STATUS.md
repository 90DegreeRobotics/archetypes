...
- **TTS candidate proven (new 2026-07-12):** Kokoro-82M through the native sherpa-onnx Windows runtime is selected for the voice lane after a real Forge spike. Seven distinct archetype audition WAVs were generated offline on CPU with no Python, cloud, CUDA, GPL runtime, or voice cloning; warm synthesis measured 0.654-0.873 RTF for the audition lines. The samples are in `artifacts/audio-proof/kokoro/`. This is a proven engine candidate, not yet in-app playback.
